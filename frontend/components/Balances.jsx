...
const Balances = () => {
    ...
    return (
        <div className='w-full h-1/4 flex justify-between items-center'>
            <div className=' w-1/3 h-full ml-6 m-3 rounded-xl bg-blue-400 flex flex-col justify-center items-center border-2 border-blue-600'>
            ...
            <div className=' w-1/3 h-full m-3 rounded-xl bg-blue-400 flex flex-col justify-center items-center border-2 border-blue-600'>
            ...
            <div className=' w-1/3 h-full mr-6 m-3 rounded-xl bg-blue-400 flex flex-col justify-center items-center border-2 border-blue-600'>
